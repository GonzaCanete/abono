...
class Product:
    ...
    def save_service_request(self, client_name, serial, problem_description, request_window):
        try:
            # Aquí se asume que tienes acceso a la información de la dirección y el modelo
            # a través del Treeview o de otros controles de la interfaz de usuario
            client_address = "Dirección predeterminada"  # Reemplazar por la forma real de obtener la dirección
            machine_model = "Modelo predeterminado"  # Reemplazar por la forma real de obtener el modelo
            voltage = "Voltaje predeterminado"  # Reemplazar por la forma real de obtener el voltaje
            ...
            with open(filename, "w") as file:
                ...
                file.write(f"Dirección: {client_address}\n")
                file.write(f"Modelo del Equipo: {machine_model}\n")
                file.write(f"Voltaje: {voltage}\n")
